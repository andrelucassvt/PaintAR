...
|---|---------|---------|-----------|-----------|--------|
| 1 | `01-fundacao-dados.md` | App em iOS 18 sobre um único container Core Data; editar e renomear voltam a persistir de verdade, com as telas atuais intactas | não — abre o contrato `PaintRepository` que as partes 2–4 consomem | — | pendente |
