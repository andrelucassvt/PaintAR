...
Skills em `.github/skills/<nome>/SKILL.md` geram código scaffolding: model, view, view-model, repository, service, navigation, animation, performance, liquid-glass, macos, payment, skill-creator.
